...
import {
  FaMapMarkerAlt, FaTimes, FaHourglassHalf, FaDownload, FaCheck, FaChevronLeft, FaChevronRight
} from 'react-icons/fa';
                    ...
                    >
                      ...
                      <div className="relative h-48 overflow-hidden bg-slate-900">
                        ...
                        <div className="absolute top-6 left-6">
                          <span className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest ${r.status === 'Approved' ? 'bg-green-600 text-white' : r.status === 'Rejected' ? 'bg-red-600 text-white' : 'bg-primary-600 text-white'
                            }`}>
                            {r.status}
                          </span>
                        </div>
