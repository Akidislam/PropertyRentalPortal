...
import { FaWallet, FaCoins, FaTimes, FaHistory, FaArrowLeft, FaPlus } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <Link to="/landlord-dashboard" className="text-sm font-bold text-slate-400 hover:text-primary-600 transition-colors uppercase tracking-widest mb-2 inline-flex items-center gap-2">
              ...
              <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-xl border border-slate-100 mb-8">
                ...
                <form onSubmit={handleAddCoins} className="max-w-2xl mx-auto space-y-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {paymentMethods.map((method) => (
                        <div
                          ...
                          className={`cursor-pointer rounded-2xl border-2 transition-all p-4 flex flex-col items-center gap-3 ${selectedPayment === method.id
                  ...
                  <button
                    ...
                    className={`w-full py-5 rounded-2xl font-black text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-xl ${submitLoading || !amount || !selectedPayment
