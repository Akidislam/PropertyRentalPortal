        ...
        <div className="space-y-32">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white p-4 rounded-[4rem] shadow-2xl overflow-hidden aspect-video relative rotate-2 hover:rotate-0 transition-transform duration-700">
               <img src="https://images.unsplash.com/photo-1570129477492-45c003edd2be?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Tenant" className="w-full h-full object-cover rounded-[3.5rem]" />
            </div>
          </div>
